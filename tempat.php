  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
        <div class="col-lg-12">
          <div class="row">
            <div class="col-xxl-4 col-md-4">
              <div class="card success-card revenue-card"><a href="/halaman/tempat/formulir-sewa.php">
                  <div class="card-body">
          ...
          <div class="col-xxl-4 col-md-4">
            <div class="card success-card revenue-card"><a href="/halaman/tempat/pengajuan.php">
                <div class="card-body">
        ...
        <div class="col-xxl-4 col-md-4">
          <div class="card success-card revenue-card"><a href="/halaman/tempat/riwayat.php">
              <div class="card-body">
        ...
        <div class="col-xxl-4 col-md-4">
          <div class="card success-card revenue-card"><a href="/halaman/tempat/data_tempat.php">
              <div class="card-body">
