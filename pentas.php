    ...
    <section class="section dashboard">
      <div class="row">
        <div class="col-lg-12">
          <div class="row">
            <div class="row">
              <div class="col-xxl-4 col-md-4">
                <div class="card success-card revenue-card"><a href="/halaman/pentas/formulir-advis.php">
                    <div class="card-body">
            ...
            <div class="col-xxl-4 col-md-4">
              <div class="card success-card revenue-card"><a href="/halaman/pentas/pengajuan.php">
                  <div class="card-body">
          ...
          <div class="col-xxl-4 col-md-4">
            <div class="card success-card revenue-card"><a href="/halaman/pentas/riwayat.php">
                <div class="card-body">
